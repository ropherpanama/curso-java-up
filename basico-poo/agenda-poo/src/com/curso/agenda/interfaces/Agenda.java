package com.curso.agenda.interfaces;

import com.curso.agenda.modelo.Contact;

/**
 * Interfaz que determina los comportamientos que debe implementar una agenda
 * 
 * @author ropherpanama
 *
 */
public interface Agenda {
	 ...
	 */
	public void updateContact(int id, Contact updated);
}
